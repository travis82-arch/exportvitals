export const byDateUiMapping = [
  ...
  { page: 'By Date', section: 'Nightly vitals', element: 'SpO2 Night Avg', sourcePaths: ['dailySpo2.spo2Average'], transform: 'parseSpo2Average', fallback: 'Not in this export', notes: 'Selected day percent' },
  { page: 'By Date', section: 'Nightly vitals', element: 'Temp deviation', sourcePaths: ['dailyReadiness.temperatureDeviation'], transform: 'toNumber', fallback: 'Not in this export', notes: 'Selected day C' },

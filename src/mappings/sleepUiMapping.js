export const sleepUiMapping = [
  ...
  { page: 'Sleep', section: 'Sleep health', element: 'Typical Sleep Score', sourcePaths: ['getBaseline(sleepScore,baselineWindow)'], transform: 'median score over baseline window', fallback: 'Not in this export', notes: 'Settings-driven window' },
  ...
  { page: 'Sleep', section: 'Overnight vitals', element: 'Average HR', sourcePaths: ['heartRateWindowSummary.avg'], transform: 'average bpm in selected night window', fallback: 'Not in this export', notes: 'Derived from night heart-rate series' },
  { page: 'Sleep', section: 'Overnight vitals', element: 'Heart-rate chart', sourcePaths: ['heartRateSeries[].bpm'], transform: 'deterministic downsample + polyline', fallback: 'Not in this export', notes: 'Max 240 points' },
  ...
  { page: 'Sleep', section: 'Breathing', element: 'Breathing regularity (BDI)', sourcePaths: ['dailySpo2.breathingDisturbanceIndex'], transform: 'toNumber', fallback: 'Not in this export', notes: 'Lower tends to be better' },
  ...
  { page: 'Sleep', section: 'Unavailable in export', element: 'Sleep details', sourcePaths: ['n/a in CSV bundle'], transform: 'none', fallback: 'Not in this export', notes: 'Placeholder text only' }
];
